...
function MI({ icon, size = 18 }: { icon: string; size?: number }) {
  return (
    <span
                  ...
                  <div className={mode === "register" ? "mb-3" : "mb-1"}>
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-1/2 -translate-y-1/2 flex items-center justify-center bg-transparent border-none cursor-pointer"
                        style={{
                          right: 10,
                      ...
                      >
                        <MI icon={showPw ? "visibility_off" : "visibility"} />
                      </button>
                    </div>
                  </div>
